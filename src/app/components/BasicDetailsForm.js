          ...
          >
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <Image
                  src="/assets/activestep-icon.png"
                  alt="Active Step"
                  width={40}
                  height={40}
                />
              ...
              <span
                className="ml-3 font-sarabun whitespace-nowrap"
                style={{
                  fontWeight: "500",
                  fontSize: "16px",
                  lineHeight: "28px",
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <Image
                  src="/assets/inactive-step-icon.png"
                  alt="Inactive Step"
                  width={40}
                  height={40}
                />
              ...
              >
                ...
                <div className="p-6 space-y-6">
                      ...
                      <div className="px-4 pb-4 space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                handleInputChange("jobType", "Full time")
                              }
                            ...
                            <button
                              onClick={() =>
                                handleInputChange("jobType", "Part time")
                              }
                              className={`px-4 py-2 h-[42px] w-[120px] rounded-lg font-sarabun text-sm font-medium ${
                            ...
                            {["Within 25 KM", "Within 50 KM", "Anywhere"].map(
                              (source) => (
                                <button
                                  key={source}
                                  onClick={() =>
                                    handleApplicationSourceChange(source)
                                  }
                  ...
                  <div className="flex justify-end pt-4">
                    <button className="bg-hamara-blue text-white px-8 py-3 rounded-lg font-sarabun font-medium hover:bg-blue-700 transition-colors">
                      Continue
                    </button>
                  </div>
                </div>
